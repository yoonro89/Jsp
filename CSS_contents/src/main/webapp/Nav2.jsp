...
<script>
	function showMenu(menuNumber) {
		...
		for (var i = 0; i < lis.length; i++) {
			lis[i].style.display = lis[i].style.display === 'block' ? 'none'
					: 'block';
		}
	}
...
<body>
	<nav>
		<ul class="menu" id="menu1">
			<h2>
				<a href="#" class="menu-link" onclick="showMenu(1)">1번 메뉴</a>
			</h2>
		...
		<ul class="menu" id="menu2">
			<h2>
				<a href="#" class="menu-link" onclick="showMenu(2)">2번 메뉴</a>
			</h2>
		...
		<ul class="menu" id="menu3">
			<h2>
				<a href="#" class="menu-link" onclick="showMenu(3)">3번 메뉴</a>
			</h2>
